...
import { getLatestEvents, formatEventDate } from '@/lib/events'
                    ...
                    <div className="p-6 bg-white flex flex-col justify-between">
                      <div>
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="px-2 py-0.5 bg-neutral-100 text-neutral-500 text-xs font-semibold rounded-full border border-neutral-200">
                            {event.year}
                          </span>
                        </div>
