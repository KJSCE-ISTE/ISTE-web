              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    'hover:before:bg-neutral-300 dark:hover:before:bg-neutral-600 hover:before:opacity-100 hover:before:duration-0 dark:hover:after:bg-neutral-600 hover:after:bg-neutral-100 hover:after:opacity-100 hover:after:duration-0',
